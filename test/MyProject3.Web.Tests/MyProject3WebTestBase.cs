...
{
    public abstract class MyProject3WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyProject3WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyProject3WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyProject3DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyProject3DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyProject3DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyProject3DbContext, Task<T>> func)
        {
            T result;
